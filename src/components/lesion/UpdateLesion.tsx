...
const UpdateLesion = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      ...
      >
        <GlobalText style={styles.title}>Update Lesion Report</GlobalText>
        <GlobalText style={styles.subtitle}>Update the patient details below</GlobalText>
      </LinearGradient>
          ...
          >
            {isUpdating ? (
              ...
              <>
                ...
                <GlobalText style={styles.buttonText}> Update Report</GlobalText>
              </>
            )}
          </LinearGradient>
        </TouchableOpacity>
