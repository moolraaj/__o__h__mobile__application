...
import { View, TouchableOpacity, TextInput, StyleSheet, Image, ScrollView, KeyboardAvoidingView, Platform, StatusBar } from 'react-native';
...
import { BACK_ARROW_COLOR, INPUT_ICON_COLOR, INPUT_ICON_SIZE, WHITE } from '../../constants/Variables';
    ...
    <SafeAreaView style={styles.wrapper} edges={['top', 'bottom']}>
      ...
      >
        ...
        >
          {step === 1 ? (
            <View>
              <GlobalText style={styles.title}>Join Us</GlobalText>
            ...
            <View>
              <View style={styles.header}>
                ...
                <GlobalText style={styles.headerTitle}>Create Account</GlobalText>
              </View>
              <View style={styles.textInputMainWrapper}>
                {(['name', 'email', 'password'] as const).map(field => (
                  <View key={field} style={styles.textInputWrapper}>
                    <GlobalText style={styles.label}>
                ...
                <View style={styles.textInputWrapper}>
                  ...
                  {passwordError !== '' && (
                    <GlobalText style={styles.errorText}>{passwordError}</GlobalText>
                  )}
                </View>
          ...
          <View style={styles.footerLink}>
            <GlobalText>I'm already a member</GlobalText>
...
const styles = StyleSheet.create({
  wrapper: { flex: 1, padding: 18, backgroundColor: WHITE },
  scrollContainer: {
    flexGrow: 1,
    paddingTop: 20,
    paddingBottom: 40,
